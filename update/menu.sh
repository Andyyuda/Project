...
echo -e "  ${BLUE}• ${GREEN}NS Domain           ${NC}= $( cat /etc/xray/dns )"
echo -e "  ${BLUE}• ${GREEN}Server IP           ${NC}= ${ipsaya}"
echo -e "  ${BLUE}• ${GREEN}ISP-VPS             ${NC}= ${ISP}"
echo -e "  ${BLUE}• ${GREEN}City                ${NC}= ${CITY}"
echo -e "  ${BLUE}• ${GREEN}Server Resource     ${NC}= $uram / $tram"
echo -e "  ${BLUE}• ${GREEN}CPU Usage           ${NC}= $cpu_usage"
echo -e "  ${BLUE}• ${GREEN}CPU Core            ${NC}= $CORE"
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= Andy Yuda & Dragon Emperor ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
